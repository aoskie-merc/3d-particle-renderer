import { Bs as Vector2, Vs as Vector3, vs as Triangle } from "./three.module-cLrRfqXO.js";
//#region node_modules/three/examples/jsm/math/MeshSurfaceSampler.js
var _face = new Triangle();
var _color = new Vector3();
var _uva = new Vector2(), _uvb = new Vector2(), _uvc = new Vector2();
/**
...
var MeshSurfaceSampler = class {
	...
	*/
	build() {
		...
		for (let i = 0; i < totalFaces; i++) {
			...
			if (weightAttribute) faceWeight = weightAttribute.getX(i0) + weightAttribute.getX(i1) + weightAttribute.getX(i2);
	...
	*/
	...
	_sampleFace(faceIndex, targetPosition, targetNormal, targetColor, targetUV) {
		...
		if (targetNormal !== void 0) if (this.normalAttribute !== void 0) {
		...
		} else _face.getNormal(targetNormal);
